...
public class ElectrodomesticoMain {
	...
	public static void main(String[] args) {
		Electrodomestico1 electrodomestico1 = new Electrodomestico1();
        ...
        Electrodomestico1 electrodomestico2 = new Electrodomestico1();
        System.out.println("\nElectrodomestico 2:");
        System.out.println(electrodomestico2);
        System.out.println("Precio final: " + electrodomestico2.precioFinal() + " €");

        Electrodomestico1 electrodomestico3 = new Electrodomestico1();
        System.out.println("\nElectrodomestico 3:");
